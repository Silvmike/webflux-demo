...
public class TestAnnotatedControllerWebHandlerServer {
    ...
    private DispatcherHandler buildWebHandler() throws Exception {
        ...
        // controller
        beanFactory.registerSingleton("okHandler", new OKHandler());
    ...
    public void testWithController() {
        ...
        WebTestClient testClient = WebTestClient.bindToController(new OKHandler()).build();
        assertTestResult(testClient);
